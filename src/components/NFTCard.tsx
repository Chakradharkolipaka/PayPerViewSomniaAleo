...
export default function NFTCard({ video }: NFTCardProps) {
  return (
    <Card className="group h-full min-h-[420px] border-slate-200/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_60px_-26px_rgba(59,130,246,0.55)]">
      ...
      <CardContent className="flex h-full flex-col justify-between space-y-6 pb-7">
        <p className="min-h-[72px] line-clamp-4 text-sm text-muted-foreground">{video.description}</p>
